...
class double_page3 extends StatefulWidget {
  const double_page3({Key? key}) : super(key: key);

  @override
  State<double_page3> createState() => double_page3State();
}

class double_page3State extends State<double_page3> {
