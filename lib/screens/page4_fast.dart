...
class page4_fast extends StatefulWidget {
  const page4_fast({Key? key}) : super(key: key);

  @override
  page4_fastState createState() => page4_fastState();
}

class page4_fastState extends State<page4_fast>
    with AutomaticKeepAliveClientMixin<page4_fast> {
  ...
  remplir1() {
    ...
    setState(() {
      ...
      energieWh = double.parse(pui.text.replaceAll(',', '.'));
      onduleur = puissanceT;
